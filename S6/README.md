Note: Images and logs are in the Folder Session 6 . was getting this at log after some time on execution `Buffered data was truncated after reaching the output size limit.`
## Base Model 
